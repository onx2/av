...
pub trait tick {
    ...
    fn tick(&self, timer: TickTimer) -> __sdk::Result<()>;
    ...
    fn on_tick(
        &self,
        callback: impl FnMut(&super::ReducerEventContext, &TickTimer) + Send + 'static,
    ) -> TickCallbackId;
...
impl tick for super::RemoteReducers {
    fn tick(&self, timer: TickTimer) -> __sdk::Result<()> {
        self.imp.call_reducer("tick", TickArgs { timer })
    }
    fn on_tick(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &TickTimer) + Send + 'static,
    ) -> TickCallbackId {
        TickCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event:
                        __sdk::ReducerEvent {
                            reducer: super::Reducer::Tick { timer },
                            ..
                        },
                    ..
                } = ctx
