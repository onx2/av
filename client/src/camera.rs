...
use crate::module_bindings::MovementSpeedRow;
...
fn update(mut messages: ReadInsertMessage<MovementSpeedRow>) {
    for msg in messages.read() {
        println!("stat inserted: {:?}", msg.row);
        // Process the stat data here
    }
}
